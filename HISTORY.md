...
7. **제품 경험 기반:** 모바일 home/room/rule partial-update/proposal/files/chat session/character 설정, pairing gate pixel-fill loading과 Desktop Agent/file UI, 8종 PNG 상태 이미지를 연결했다.
